...
- gehärteter Stack mit Vaultwarden 1.37.1 unter `vault.zircula.org`
...
- seit 24. September 2026 laufender Pin
...
- seit 25. September 2026 laufender Release Candidate `v0.1.0-rc.2`, Commit
  `ffb675bd6d547d30c3ed729082b0e58e1f60aeb5`; isolierter Build
  mit Image-ID
  ...
  `identities.0004_user_preferred_workshop_view`; zentraler Backup-Lauf und
  Preflight erfolgreich, Migration separat angewendet und ausschließlich der
...
- seit 25. September 2026 laufender Werkblatt-Pin
  `cf1b749899790fc977327609c2703817756b458b`
  mit isoliert gebauter Image-ID
  `sha256:29ffbfbf000943a4e517970f2ef81e5d396e1c11ad06e39d6ada08187ba57aaa`
  ergänzt eine geführte, organisationsgebundene Erstellung und
  ...
  Backup, Preflight und separate Migration erfolgreich; ausschließlich der
  Webcontainer ersetzt, PostgreSQL und übrige Infrastruktur unverändert;
...
## Validierung Vaultwarden-Update vom 30.07.2026

Erfolgreich geprüft:

- vollständiges Vorher-Backup bei gestopptem Container mit SHA-256-Prüfsumme
- Wartungsupdate von Vaultwarden 1.37.0 auf 1.37.1
- Container-Healthcheck, öffentliche `/alive`-Route und fehlerfreie Startlogs
- unverändertes Rootless-, Read-only-, Capability- und Port-Hardening
- Authentik-SSO, MFA, Master-Passwort und bestehender Tresor
- Erstellen, Ändern, Synchronisieren und Löschen eines Testeintrags
- Abmeldung, erneute Anmeldung und SMTP-Nachtest
