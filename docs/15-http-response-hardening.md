...
diesen Regeln über das Snippet `security_headers` eingebunden.
...
Zusätzlich werden die regulären Dienst-Healthchecks und der Nextcloud-Status
geprüft. Ein fehlender Versionsheader allein ist kein ausreichender
Funktionsnachweis.
