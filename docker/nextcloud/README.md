...
direkt `http://nextcloud`; dieser interne Name wird gemäß
`docs/14-client-push.md` einmalig per `occ` als zusätzliche Trusted Domain in
der persistenten Nextcloud-Konfiguration ergänzt.
